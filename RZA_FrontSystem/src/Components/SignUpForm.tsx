            ...
            <MDBCol md='6'>
              <MDBCardBody className='d-flex flex-column'>
                ...
                <h5 className="fw-normal my-4 pb-3" style={{letterSpacing: '1px'}}>Create your account</h5>
                  ...
                  <MDBInput wrapperClass='mb-4' label='First Name' id='formControlLg' type='text' size="lg" onChange={(e) => setFname(e.target.value)} />
                  <MDBInput wrapperClass='mb-4' label='Last Name' id='formControlLg' type='text' size="lg" onChange={(e) => setLname(e.target.value)} />
                  <MDBInput wrapperClass='mb-4' label='Date of Birth' id='formControlLg' type='string' size="lg" onChange={(e) => setDOB(e.target.value)} />
                  ...
                  <MDBInput wrapperClass='mb-4' label='Confirm Password' id='formControlLg' type='password' size="lg" onChange={(e) => setConfirm(e.target.value)} />
   
                <MDBBtn className="mb-4 px-5" color='dark' size='lg' onClick={handleSubmit}>Sign Up</MDBBtn>
                <a className="small text-muted" href="#!">Forgot password?</a>
                <p className="mb-5 pb-lg-2" style={{color: '#393f81'}}>Already got an account? <a href="/login" style={{color: '#393f81'}}>Login here</a></p>
