...
const STAYFORM_PATH = "/stayform"
const MEMBER_SIGN_UP_PATH  = "/membershipsignup"
const NOT_FOUND_PATH = "*";

export {MEMBER_SIGN_UP_PATH, STAYFORM_PATH, CONFIRM_PATH,INDEX_PATH, TICKET_PATH,SIGN_UP_PATH, LOGIN_PATH, BOOKING_PATH,HELP_PATH ,ACCOUNT_PATH, SOCIAL_MEDIA_PATH, NOT_FOUND_PATH, INFO_PATH, HOTEL_PATH, EDUCATION_PATH, MEMBER_PATH};